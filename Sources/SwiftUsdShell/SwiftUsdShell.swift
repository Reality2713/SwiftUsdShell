...
// MARK: - RealityKit Extension DTOs

public struct USDTimelineInfo: Hashable, Sendable, Codable {
    public var path: String
    public var name: String
...
public struct USDBehaviorInfo: Hashable, Sendable, Codable {
    public var path: String
    public var name: String
...
public struct USDAnchorInfo: Hashable, Sendable, Codable {
    public var path: String
...
public struct USDRealityKitExtensionsInfo: Hashable, Sendable, Codable {
...
public struct USDTimelineTrackInfo: Hashable, Sendable, Codable {
    public var path: String
    public var name: String
    ...
    public init(
        path: String,
        name: String,
        actions: [USDRealityKitActionInfo] = []
    ) {
        self.path = path
        self.name = name
...
public struct USDRealityKitActionInfo: Hashable, Sendable, Codable {
    public var path: String
    public var name: String
...
public struct USDTimelineStructureInfo: Hashable, Sendable, Codable {
    public var path: String
...
public struct USDBehaviorConnection: Hashable, Sendable, Codable {
...
public struct USDBehaviorGraphInfo: Hashable, Sendable, Codable {
    public var path: String
